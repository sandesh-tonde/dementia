...
public class BlogAsserts {
     ...
     */
    public static void assertBlogMapsIdRelationshipPersistedValue(Blog entityToPersist, Blog persisted) {
        // Validate the id for MapsId, the ids must be same
        assertThat(entityToPersist.getAuther().getId()).isEqualTo(persisted.getId());
    }
    ...
    public static void assertBlogUpdatableFieldsEquals(Blog expected, Blog actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getVote()).as("check vote").isEqualTo(actual.getVote()));
    }
