...
public class CommentTestSamples {
    ...
    public static Comment getCommentSample1() {
        return new Comment().id(1L).commentText("commentText1");
    }

    public static Comment getCommentSample2() {
        return new Comment().id(2L).commentText("commentText2");
    }

    public static Comment getCommentRandomSampleGenerator() {
        return new Comment().id(longCount.incrementAndGet()).commentText(UUID.randomUUID().toString());
    }
}
