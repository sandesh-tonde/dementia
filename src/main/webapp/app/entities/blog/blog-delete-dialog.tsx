...
export const BlogDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/blog' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dementiaApp.blog.delete.question">
        <Translate contentKey="dementiaApp.blog.delete.question" interpolate={{ id: blogEntity.id }}>
