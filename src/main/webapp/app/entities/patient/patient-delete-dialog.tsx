...
export const PatientDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/patient' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dementiaApp.patient.delete.question">
        <Translate contentKey="dementiaApp.patient.delete.question" interpolate={{ id: patientEntity.id }}>
