...
!(function ($) {
  ...
  var Datepicker = function (element, options) {
    ...
    this.picker = $(DPGlobal.template)
      .appendTo('body')
      .hide()
      .on('mousedown.Datepicker', $.proxy(this.mousedown, this))
      .on('click.Datepicker', $.proxy(this.click, this));
  ...
  Datepicker.prototype = {
    ...
    show: function (e) {
      ...
      if (this.scroll && docScrollTop + winHeight < elemTop + elemHeight) $(document).scrollTop(elemTop - elemHeight);
    },
