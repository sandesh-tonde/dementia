      ...
      this.$element.find('[data-stellar-ratio]').each(function (i) {
        ...
        horizontalOffset =
          $this.data('stellar-horizontal-offset') !== undefined
            ...
            : $offsetParent !== undefined && $offsetParent.data('stellar-horizontal-offset') !== undefined
        ...
        verticalOffset =
          $this.data('stellar-vertical-offset') !== undefined
            ...
            : $offsetParent !== undefined && $offsetParent.data('stellar-vertical-offset') !== undefined
        ...
        if (this.options.hideDistantElements) {
          isVisibleHorizontal =
            ...
            (newOffsetLeft + particle.width > (particle.isFixed ? 0 : scrollLeft) &&
              newOffsetLeft < (particle.isFixed ? 0 : scrollLeft) + this.viewportWidth + this.viewportOffsetLeft);
          isVisibleVertical =
            !this.options.verticalScrolling ||
            (newOffsetTop + particle.height > (particle.isFixed ? 0 : scrollTop) &&
              newOffsetTop < (particle.isFixed ? 0 : scrollTop) + this.viewportHeight + this.viewportOffsetTop);
        }
