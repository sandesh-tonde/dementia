...
!(function t(e, i, s) {
...
})(
  {
    ...
    2: [
      function (t, e) {
        function i(t, e) {
          ...
          function i(t, e, i, s) {
            t.addEventListener
              ? t[i ? 'addEventListener' : 'removeEventListener'](e, s)
              : t[i ? 'attachEvent' : 'detachEvent']('on' + e, s);
          }
          function n() {
          ...
          return t.nodeName
            ? 'img' !== t.nodeName.toLowerCase()
              ? e(new Error('Element supplied is not an image'))
              : t.src && t.complete && void 0 !== t.naturalWidth
                ? e(null, !0)
                : (i(t, 'load', !0, n),
                  i(t, 'error', !0, n),
                  (t.readyState || t.complete) && ((r = t.src), (t.src = s), (t.src = r)),
                  void 0)
            : e(new Error('First argument must be an image element'));
        }
      ...
      function (t, e) {
        ...
        (i.prototype.getImageSrcs = function (t) {
          ...
          (i.prototype.determineUrlAndType = function (t) {
            ...
            return (
              ('' !== s.backgroundImage && 'none' !== s.backgroundImage) ||
              ('' !== t.style.backgroundImage && 'none' !== t.style.backgroundImage)
                ? ((e = s.backgroundImage || t.style.backgroundImage), (i = 'background'))
                : 'undefined' != typeof t.getAttribute('src') && 'img' === t.nodeName.toLowerCase() && (e = t.getAttribute('src')),
              { url: e, type: i }
            );
          }),
    ...
    6: [
      function (t, e) {
        ...
        (i.prototype.init = function () {
          ...
          (i.prototype.calculatePosition = function () {
            ...
            var t = 'absolute';
            return (
              'body' === this.parentElement.tagName.toLowerCase()
                ? (t = 'fixed')
                : ('fixed' !== this.parentElement.style.position || 'absolute' !== this.parentElement.style.position) &&
      ...
      { './LoadingBar.js': 4, './Percentage.js': 5 },
    ],
    7: [
      function () {
        ...
        (i.prototype.init = function () {
          ...
          (i.prototype.updateProgress = function (t, e) {
            ...
            this.overlay.updateProgress((t / e) * 100, this.options.minimumTime),
              t === e &&
                this.done === !1 &&
                (window.clearTimeout(this.maxTimeout), window.setTimeout(this.doneLoading.bind(this), this.options.minimumTime));
          }),
