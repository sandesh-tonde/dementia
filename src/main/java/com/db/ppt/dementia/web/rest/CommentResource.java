...
/**
 * REST controller for managing {@link com.db.ppt.dementia.domain.Comment}.
 */
@RestController
...
public class CommentResource {
    ...
    public ResponseEntity<Comment> createComment(@RequestBody Comment comment) throws URISyntaxException {
        ...
        if (Objects.isNull(comment.getAddedBy())) {
            throw new BadRequestAlertException("Invalid association value provided", ENTITY_NAME, "null");
        }
        Long userId = comment.getAddedBy().getId();
        userRepository.findById(userId).ifPresent(comment::addedBy);
